      ...
      >
        <Paper sx={{ padding: 2 }}>
          <Grid container spacing={3}>
            <Grid item>
              <FacebookShareButton
                url={`${current_loc}details/${props.id}`}
                quote={message}
              >
      ...
      >
        <CardContent>
          ...
          <a href={`details/${props.id}`}>
            ...
            >
              <h5>{props.title}</h5>
              <Typography sx={{ lineClamp: "initial" }}>
                <i
                  className="fa fa-location"
                  style={{ padding: "2%", color: ctr, fontSize: 15 }}
                ></i>
                {props.location}
              </Typography>
            </div>
        ...
        >
          ...
          >
            ...
            <Button
              ...
              id={props.remove}
            >
              <i className="fa fa-heart"></i> {props.remove}Save
            </Button>
            <Button
              onClick={() => {
                setPopupShare(true);
